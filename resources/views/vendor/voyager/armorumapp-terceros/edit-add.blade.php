                    ...
                    <form role="form" class="form-edit-add"
                        ...
                        <div class="panel-body">
                            ...
                            {{-- <div class="form-group">
                                <label for="documento_tercero">{{ __('Nombre de Usuario') }}</label>
                                <input type="text" disabled="true" class="form-control" id="documento_tercero" name="documento_tercero"
                                    placeholder="{{ __('Nombre de Usuario') }}"
                                    value="{{ old('documento_tercero', $dataTypeContent->documento_tercero ?? '') }}">
                            </div> --}}
