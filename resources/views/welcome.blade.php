        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    @auth
                        <a href="{{ url('/admin') }}" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Registrarme</a>
                        @endif
                    @endauth
                </div>
            @endif
                    ...
                    @endif
                        ...
                        <div class="carousel-item">
                            ...
                            @if($admin_bg_image == '')
                                <img src="{{ voyager_asset('images/logo-icon-light.png') }}" alt="Logo Icon">
                                @else
                        <img src="{{ Voyager::image($admin_bg_image) }}" alt="Logo Icon">
                    @endif
                        </div>
...
{{-- 
     ...
     <section class="container my-5">
        <h2>Conoce nuestras políticas de servicio</h2>
        <p>Aquí puedes describir tus políticas de servicio.</p>
    </section>

    <!-- Información sobre trámites y servicios -->
    <section class="bg-light py-5">
        <div class="container">
            <h2>Lo que debes saber para usar nuestros trámites y servicios</h2>
            <p>Aquí puedes proporcionar información útil sobre cómo utilizar tus servicios.</p>
        </div>
    </section>

    <!-- Contactenos con mapa y formulario -->
    <section class="container my-5">
        <h2>Contactenos</h2>
        <div class="row">
            <div class="col-md-6">
                <!-- Inserta aquí el mapa, puedes utilizar Google Maps -->
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387089.9753888482!2d-74.25986429040166!3d40.69714942279934!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20EE.%20UU.!5e0!3m2!1ses-419!2sco!4v1618508477045!5m2!1ses-419!2sco" width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
            <div class="col-md-6">
