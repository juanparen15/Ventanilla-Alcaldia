                                    ...
                                    @foreach ($dataTypeContent as $data)
                                        <tr>
                                            ...
                                            @foreach ($dataType->browseRows as $row)
                                                ...
                                                @endphp
                                                <td>
                                                    @if ($row->field == 'documento_tercero')
                                                        @if ($data->documento_tercero)
                                                            {{ $data->documento_tercero }}
                                                        @else
                                                    ...
                                                    @elseif ($row->field == 'codigo_evento_detalle')
                                                        ...
                                                        @else
                                                            {{ __('voyager::generic.none') }}
                                                        @endif
                                                    @elseif ($row->field == 'codigo_arma')
                                                        @if ($data->{$row->field})
                                                            @php
                                                                $tipoArmasIds = json_decode($data->{$row->field}); // Si los IDs están en formato JSON
                                                            @endphp

                                                            @if ($tipoArmasIds)
                                                                @foreach ($tipoArmasIds as $arma)
                                                                    @php
                                                                        $arma = \App\Models\Arma::find($arma);
                                                                    @endphp
                                                                    @if ($arma)
