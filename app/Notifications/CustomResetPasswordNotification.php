...
class CustomResetPasswordNotification extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        ...
        ->line(Lang::get('Estás recibiendo este correo electrónico porque hemos recibido una solicitud para restablecer la contraseña de tu cuenta.'))
        ...
        ->line(Lang::get('Si no solicitaste restablecer tu contraseña, no es necesario realizar ninguna otra acción.'));
