        ...
        <div class="navbar-header">
            ...
            @section('breadcrumbs')
                <ol class="breadcrumb hidden-xs">
                    ...
                    @endphp
                    @if (count($segments) == 0)
                        <li class="active"><i class="voyager-pie-chart"></i> {{ __('voyager::generic.dashboard') }}</li>
                    @else
                        <li class="active">
                            <a href="{{ route('voyager.dashboard') }}"><i class="voyager-pie-chart"></i>
                ...
                <ul class="dropdown-menu dropdown-menu-animated">
                    <li class="profile-img">
                        ...
                        <div class="profile-body">
                            <h5>{{ Auth::user()->primer_nombre . ' ' . Auth::user()->segundo_nombre }}</h5>
                            <br></br>
